...
def predict(image, crop):
  ...
  if crop=='rice':
    ...
    from statics.disease import Maize

    # /Users/roshan/project/deltathon/deltathon/backend/static
    # dictDisease = disease.Maize
    print(Maize)
  elif crop=='apple':
  ...
  return fclass[conf.item()], pred.item() * 100

print(predict('../image/temp.jpeg', 'maize'))