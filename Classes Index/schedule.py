...
data =  { 'Cauliflower' : [
        ...
        },
        {
            ...
            'endday' : 28,
            'endtime' : (28 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 30,
            'endtime' : (30 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 34,
            'endtime' : (34 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 40,
            'endtime' : (40 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
       
        {
            ...
            'endday' : 60,
            'endtime' : (60 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 75,
            'endtime' : (75 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
    ],
    'Onion' : [
        ...
        },
        {
            ...
            'endday' : 11,
            'endtime' : (11 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 15,
            'endtime' : (15 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'subtitle' : 'This time of the planting, it needs some fertilizer. So, use fertilizer recommendation service and put fertilizer as per recommended.',
            'endday' : 21,
            'endtime' : (21 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'subtitle' : 'This time of the planting, it needs some fertilizer. So, use fertilizer recommendation service and put fertilizer as per recommended.',
            'endday' : 35,
            'endtime' : (35 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'endday' : 45,
            'endtime' : (45 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
...

        {
            ...
            'subtitle' : 'Plant growth regulators (PGRs) are chemicals used to modify plant growth such as increasing branching, suppressing shoot growth, increasing return bloom, removing excess fruit, or altering fruit maturity. Consult with agri-doctors to apply best PGR.',
            'endday' : 70,
            'endtime' : (70 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'subtitle' : 'This time of the planting, it needs some fertilizer. So, use fertilizer recommendation service and put fertilizer as per recommended.',
            'endday' : 80,
            'endtime' : (80 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'subtitle' : 'Plant growth regulators (PGRs) are chemicals used to modify plant growth such as increasing branching, suppressing shoot growth, increasing return bloom, removing excess fruit, or altering fruit maturity. Consult with agri-doctors to apply best PGR.',
            'endday' : 90,
            'endtime' : (90 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
        {
            ...
            'subtitle' : 'By this time, the cauliflower must be ready to be harvested up.',
            'endday' : 100,
            'endtime' : (100 * 86400) + int(time.time()),
            'is_done' : False,
            '_time' : int(time.time())
        },
    ],
...
for temp in data['Cauliflower']:
    temp['endday'] = int((temp['endtime'] - int(time.time())) / 86400)
    print(temp['endday']) #temp['endday'])